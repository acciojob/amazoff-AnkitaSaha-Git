...
public class OrderRepository {
    ...
    public HashMap<String,String> orderDeliveryPartnerHashMap;

    public HashMap<String, HashSet<String>> allOrdersOfPartner;
    ...
    public List<String> getOrdersByPartnerId(String partnerId ){
        ...
        if(allOrdersOfPartner.containsKey(partnerId))
            orderList=allOrdersOfPartner.get(partnerId);
        ...
        if(allOrdersOfPartner.containsKey(partnerId)){
            ...
            for(String order:orders){
                if(orderHashMap.containsKey(order)){
                    ...
                    if(currOrder.getDeliveryTime()>time){
                        countOfOrders++;
                    }
                }
            }
